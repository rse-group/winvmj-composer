package webshop.product.fullfeature;
...
import webshop.paymentorder.PaymentOrderResourceFactory;
import webshop.paymentorder.core.PaymentOrderResource;
import webshop.paymentorder.PaymentOrderServiceFactory;
import webshop.paymentorder.core.PaymentOrderService;
...
public class FullFeature {
	...
	public static void main(String[] args) {
		...
		configuration.addAnnotatedClass(webshop.order.unauthorized.OrderImpl.class);
		configuration.addAnnotatedClass(webshop.paymentorder.core.PaymentOrder.class);
		configuration.addAnnotatedClass(webshop.paymentorder.core.PaymentOrderComponent.class);
		configuration.addAnnotatedClass(webshop.paymentorder.core.PaymentOrderDecorator.class);
		configuration.addAnnotatedClass(webshop.paymentorder.core.PaymentOrderImpl.class);
	...
	public static void createObjectsAndBindEndPoints() {
        ...
        OrderService unauthorizedOrderService = OrderServiceFactory
            .createOrderService("webshop.order.unauthorized.OrderServiceImpl"
            	, orderOrderService);		

        OrderResource unauthorizedOrderResource = OrderResourceFactory
            .createOrderResource("webshop.order.unauthorized.OrderResourceImpl"
                , orderOrderResource, orderOrderService);
			
        OrderService simplifiedOrderService = OrderServiceFactory
            .createOrderService("webshop.order.simplified.OrderServiceImpl"
            	, orderOrderService);		

        OrderResource simplifiedOrderResource = OrderResourceFactory
            .createOrderResource("webshop.order.simplified.OrderResourceImpl"
                , orderOrderResource, orderOrderService);
			
        PaymentOrderService paymentorderPaymentOrderService = PaymentOrderServiceFactory
            .createPaymentOrderService("webshop.paymentorder.core.PaymentOrderServiceImpl"
            	);		

        PaymentOrderResource paymentorderPaymentOrderResource = PaymentOrderResourceFactory
            .createPaymentOrderResource("webshop.paymentorder.core.PaymentOrderResourceImpl"
                );
			
        PaymentOrderService creditcardPaymentOrderService = PaymentOrderServiceFactory
            .createPaymentOrderService("webshop.paymentorder.creditcard.PaymentOrderServiceImpl"
            	, paymentorderPaymentOrderService);		

        PaymentOrderResource creditcardPaymentOrderResource = PaymentOrderResourceFactory
            .createPaymentOrderResource("webshop.paymentorder.creditcard.PaymentOrderResourceImpl"
                , paymentorderPaymentOrderResource, paymentorderPaymentOrderService);
			
        PaymentOrderService ewalletPaymentOrderService = PaymentOrderServiceFactory
            .createPaymentOrderService("webshop.paymentorder.ewallet.PaymentOrderServiceImpl"
            	, paymentorderPaymentOrderService);		

        PaymentOrderResource ewalletPaymentOrderResource = PaymentOrderResourceFactory
            .createPaymentOrderResource("webshop.paymentorder.ewallet.PaymentOrderResourceImpl"
                , paymentorderPaymentOrderResource, paymentorderPaymentOrderService);
			

		System.out.println("ewalletPaymentOrderResource endpoints binding");
		Router.route(ewalletPaymentOrderResource);
		
		System.out.println("ewalletPaymentOrderService endpoints binding");
		Router.route(ewalletPaymentOrderService);
		
		System.out.println("creditcardPaymentOrderResource endpoints binding");
		Router.route(creditcardPaymentOrderResource);
		
		System.out.println("creditcardPaymentOrderService endpoints binding");
		Router.route(creditcardPaymentOrderService);
		
		System.out.println("paymentorderPaymentOrderResource endpoints binding");
		Router.route(paymentorderPaymentOrderResource);
		
		System.out.println("paymentorderPaymentOrderService endpoints binding");
		Router.route(paymentorderPaymentOrderService);
		
		System.out.println("simplifiedOrderResource endpoints binding");
		Router.route(simplifiedOrderResource);
		
		System.out.println("simplifiedOrderService endpoints binding");
		Router.route(simplifiedOrderService);
		
		System.out.println("unauthorizedOrderResource endpoints binding");
		Router.route(unauthorizedOrderResource);
		
		System.out.println("unauthorizedOrderService endpoints binding");
		Router.route(unauthorizedOrderService);
	...
	private static Map<String, Object> mappingFeatureModel() {
		...
		featureModelMappings.put(
			...
			new HashMap<String, String[]>() {{
				...
				put("deltas", new String[] {
					webshop.order.unauthorized.OrderImpl.class.getName()
				});
			}}
        );

		featureModelMappings.put(
            webshop.paymentorder.core.PaymentOrderComponent.class.getName(),
			new HashMap<String, String[]>() {{
				put("components", new String[] {
					webshop.paymentorder.core.PaymentOrderComponent.class.getName()
				});
