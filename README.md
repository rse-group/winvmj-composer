...
- [WinVMJProduct](https://gitlab.com/RSE-Lab-Fasilkom-UI/PricesIDE/winvmj-composer/-/blob/plugin-dev/de.ovgu.featureide.core.winvmj/src/de/ovgu/featureide/core/winvmj/WinVMJComposer.java): a class that defines a WinVMJ product variation based on config or generated product.
