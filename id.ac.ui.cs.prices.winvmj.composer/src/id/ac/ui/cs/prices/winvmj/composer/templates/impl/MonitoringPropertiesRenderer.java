...
public class MonitoringPropertiesRenderer extends TemplateRenderer {
	...
	protected Map<String, Object> extractDataModel(WinVMJProduct product) {
		...
		dataModel.put("monitoringEnabled", MonitoringUtils.isMonitoringEnabled(project));
		dataModel.put("monitoredFeatures", MonitoringUtils.getMonitoredFeatures(project));
		return dataModel;
	}
