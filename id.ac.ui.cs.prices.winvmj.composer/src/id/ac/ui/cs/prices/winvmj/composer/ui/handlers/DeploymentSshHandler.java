...
public class DeploymentSshHandler extends AFeatureProjectHandler {
    
    @Override
    protected void singleAction(IFeatureProject project) {
        WinVMJConsole.showConsole();
        WinVMJConsole.println("[Deploy SSH] Opening SSH deployment wizard...");
        
        Shell shell = PlatformUI.getWorkbench().getActiveWorkbenchWindow().getShell();
        DeploymentSshWizard wizard = new DeploymentSshWizard(project);
