package id.ac.ui.cs.prices.winvmj.composer;
...
import id.ac.ui.cs.prices.winvmj.composer.core.impl.MicroserviceProductToCompose;
import id.ac.ui.cs.prices.winvmj.composer.core.impl.MultiLevelDeltaComposer;
	...
	private boolean initExtraConfigFiles(IFeatureProject project) {
		...
		try {
			...
			if (!monitoringConfigFile.exists()) {
				String monitoringContent = Utils.createDefaultMonitoringConfigContent();
